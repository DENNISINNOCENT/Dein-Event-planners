  ...
  return (
    <div>
      ...
      <div className="font-[Poppins] m-2 ">
        ...
        <div>
          <p><FontAwesomeIcon icon={faArrowRight} />We are dedicated at transforming your event </p>
          <p> to be one of the memorable one in your life time.</p>
          <p><FontAwesomeIcon icon={faArrowRight} />We offer all your event needs as a package </p>
          <p> avoiding you all the work or troubles you may experience.</p>

          <p><FontAwesomeIcon icon={faArrowRight} />
